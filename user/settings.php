      ...
      <?php require($_SERVER['DOCUMENT_ROOT'] . "/assets/navigation_menu.php"); ?>
		   ...
		   <div class="col-lg-3 col-md-6">
			<div class="panel panel-red">
			  ...
			  <a href="#">
				...
				<a href="/user/settings/config_bins.php"><span class="pull-left">Configure Bins</span></a>
		...
		<div class="row">
		   <div class="col-lg-3 col-md-6">
			  ...
			  <a href="#">
			     <div class="panel-footer">
				<a href="/user/settings/update_profile.php"><span class="pull-left">Update Profile</span></a>
				<span class="pull-right">
				  <i class="fa fa-arrow-circle-right"></i>
				</span>
				<div class="clearfix"></div>
